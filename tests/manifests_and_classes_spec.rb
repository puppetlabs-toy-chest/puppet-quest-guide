...
describe "Task 1:", host: :cowsay do
  it 'has a working solution', :solution do
    command("echo \"notify\ { 'Hello Puppet!': }\" >> /tmp/hello.pp")
      .exit_status
      .should eq 0
  end
  it 'Create a temporary hello.pp manifest', :validation do
    file('/tmp/hello.pp')
      .content
...
describe "Task 2:", host: :localhost do
  ...
  it 'Make the cowsay module directory', :validation do
...
describe "Task 3:", host: :localhost do
  ...
  it 'Create the cowsay default manifest', :validation do
...
describe "Task 4:", host: :localhost do
  ...
  it 'Update site.pp with classification for cowsay.puppet.vm', :validation do
...
describe "Task 5:", host: :cowsay do
  ...
  it 'Run the agent and test cowsay', :validation do
    package('cowsay')
      .should be_installed
      .by('gem')
  end
...
describe "Task 6:", host: :localhost do
  ...
  it 'Create the cowsay::fortune class', :validation do
...
describe "Task 7:", host: :localhost do
  ...
  it 'Include the cowsay::fortune class into the default class', :validation do
    file("#{MODULE_PATH}/cowsay/manifests/init.pp")
      .content
...
describe "Task 8:", host: :cowsay do
  ...
  it 'Run the agent and test cowsay with fortune', :validation do
    package('fortune-mod')
      .should be_installed
  end
end
