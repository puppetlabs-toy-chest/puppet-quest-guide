describe _("Task 1:", host: :localhost) do
  it _('Install the PostgreSQL Puppet module') do
...
describe _("Task 2:", host: :localhost) do
  it _('Create the pasture::db wrapper class') do
...
describe _("Task 3:", host: :localhost) do
  it _('Classify the database node') do
...
describe _("Task 4:", host: :localhost) do
  it _('Update the pasture main manifest with a db parameter') do
...
describe _("Task 5:", host: :localhost) do
  it _('Update the pasture configuration file template with a db parameter') do
...
describe _("Task 6:", host: :pastureapp) do
  it _('Trigger an agent run on pasture-app.puppet.vm and test service') do
    package('thin')
      .should be_installed
      .by('gem')
    process('pasture')
