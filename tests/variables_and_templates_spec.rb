describe _("Task 1:", host: :localhost) do
  it _('Add variables to the pasture main manifest') do
...
describe _("Task 2:", host: :localhost) do
  it _('Create pasture configuration file template') do
...
describe _("Task 3:", host: :localhost) do
  it _('Use pasture configuration file template') do
    file("#{MODULE_PATH}pasture/manifests/init.pp")
      .content
...
describe _("Task 4:", host: :localhost) do
  it _('Create pasture service unit file template') do
...
describe _("Task 5:", host: :localhost) do
  it _('Use pasture service unit file template') do
    file("#{MODULE_PATH}pasture/manifests/init.pp")
      .content
