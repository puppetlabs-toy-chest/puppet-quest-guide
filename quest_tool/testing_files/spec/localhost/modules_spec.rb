...
describe "The directory for the new vimrc module" do
  it 'should be created' do
    file('/etc/puppetlabs/puppet/modules/vimrc').should be_directory
  end
end
...
describe "The directories for manifests, tests, and files" do
  it 'should be created' do
    file('/etc/puppetlabs/puppet/modules/vimrc/manifests').should be_directory
    file('/etc/puppetlabs/puppet/modules/vimrc/tests').should be_directory
    file('/etc/puppetlabs/puppet/modules/vimrc/files').should be_directory
  end
end
...
describe "The vimrc file" do
  it 'should be copied into the module files directory' do
    file('/etc/puppetlabs/puppet/modules/vimrc/files/vimrc').should be_file
  end
end
...
describe "The vimrc/files/vimrc file" do
  it "should contain the 'set number' command" do
    file('/etc/puppetlabs/puppet/modules/vimrc/files/vimrc').should contain /set nu/
  end
end
...
describe 'The test manifest for the users class' do
  it 'should include the vimrc class' do
    file('/etc/puppetlabs/puppet/modules/vimrc/tests/init.pp').should contain 'include vimrc'
  end
end
