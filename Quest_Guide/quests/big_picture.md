...
{% task 1 %}
To get started with setting up our Quest Guide website, we need to download and install the [apache module](http://forge.puppetlabs.com/puppetlabs/apache) from the Puppet Forge. In your terminal type the following command:
...
Great job! You've just installed your first module from the Puppet Forge. Pretty easy don't you think? We also went ahead and pre-installed lvmguide module on your behalf.
...
The Puppet Enterprise Console is Puppet’s web Graphical User Interface (GUI). The PE Console allows you to use Puppet for many automation tasks without the need to write code. You can use it to:
...
Please write down your returned ip address as you will need it to access the Puppet Enterprise Console. Next, in your browsers address bar, type the following URL: **https://your-ip-address**.
...
Awesome! You are at the doorstep of the Puppet Enterprise Console. Enter the login information below to gain access:
